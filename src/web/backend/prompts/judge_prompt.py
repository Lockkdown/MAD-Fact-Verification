"""Judge prompt builder — copied from src/orchestrator/agents/prompts/judge_prompt.py."""

import random

from prompts.debater_prompt import DEBATER_R1_SYSTEM
...
def _format_debate_transcript(all_rounds: list[dict], is_unanimous: bool) -> str:
    """Format the debate transcript with shuffled, anonymized labels for split cases."""
